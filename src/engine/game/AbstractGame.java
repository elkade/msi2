...
public abstract class AbstractGame implements Logic {
	...
	public String TEST_BOT_1; // command for the test bot in DEV_MODE
	public String TEST_BOT_2; // command for the test bot in DEV_MODE
	...
	public void setupEngine(String args[]) throws IOException, RuntimeException {
		...
		if(DEV_MODE) {
			if(TEST_BOT_1.isEmpty() || TEST_BOT_2.isEmpty()) {
